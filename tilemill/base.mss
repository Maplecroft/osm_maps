...
#landuse[zoom>12] {
  ...
  [type='park']          { polygon-fill: @park; polygon-opacity: 0.8; }
  ...
  [type='wood']          { polygon-fill: @wooded; polygon-opacity: 0.6; }
}
...
#country_boundary {
  ...
  line-join: round;
  line-color:@admin_2;
  [zoom<4]  { line-opacity: 0.4; line-width: 0.6; }
  [zoom>=4] { line-opacity: 0.6; line-width: 0.7; line-color:darken(@admin_2,15);}
}


#admin_boundary[zoom>5] {
  line-cap: round;
  line-join: round;
  line-color:darken(@admin_3,15);
  line-opacity: 0.5; 
  line-width: 0.5;
}
...
#admin[admin_level=2][zoom>1] {
  line-color:@admin_2;
  [zoom=2] { line-opacity: 0.25; line-width: 0.6; }
  [zoom=3] { line-opacity: 0.3; line-width: 0.6; }
  [zoom=4] { line-opacity: 0.4; line-width: 0.6; }
  [zoom=5] { line-opacity: 0.6; line-width: 0.8; }
  [zoom=6] { line-opacity: 0.8; line-width: 1; }
}

#admin[admin_level=3][admin_level=4][zoom>5] {
  line-color:@admin_3;
  [zoom=6] { line-opacity: 0.4; line-width: 0.6; }
  [zoom>6] { line-opacity: 0.6; line-width: 0.8; }
}
*/
