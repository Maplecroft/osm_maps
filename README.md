...
Ubuntu Postgreswql configuration file is found here: `/etc/postgresql/9.1/main/postgresql.conf`.
...
up the PostGIS database, and in particular the imposm set-up instructions. You 
will need to reference [imposm-mapping.py](https://github.com/mapbox/osm-bright/blob/master/imposm-mapping.py).
